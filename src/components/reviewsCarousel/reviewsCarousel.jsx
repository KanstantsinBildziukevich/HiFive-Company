        ...
        <CarouselWrapper>
            ...
            >
                <Review
                    ...
                    description={'On behalf of H&K Soft Company, I would like to extend our appreciation to HiFive for their exceptional work in delivering several financial projects for us. We are extremely satisfied with the results and are looking forward to continuing our partnership for future projects.'}
                />
                <Review
                    avatar={avatar2}
                    title={
                    ...
                    description={'SQRD.tech SRL (Italy) highly recommends HiFive as a trusted partner for complex fintech projects. The company consistently provides exceptional support and demonstrates a remarkable ability to resolve any issues in a timely manner. We are grateful for HiFive\'s dedication to ensuring the success of our projects and appreciate their expertise in the field. Thank you for your commitment to excellence!'}
                />
                <Review
                    avatar={avatar3}
                    title={
                ...
                <Review
                    ...
                    description={'Owls Group gives thanks to HiFive for helping with development an application for a private clinic in the USA. Fast, clear, professional. '}
                />
                <Review
                    avatar={avatar5}
                    title={
                    ...
                    description={'On behalf of our company, we would like to thank the HiFive team for their professionalism and punctuality. We definitely recommend contacting HiFive for IT solutions of any complexity.'}
                />
            </Carousel>
        </CarouselWrapper>
    );
